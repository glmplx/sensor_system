...
DECREASE_SLOPE_THRESHOLD = -1.5-1.5-0.5-0.5  # Seuil négatif pour détecter une diminution de conductance en µS/s
SLIDING_WINDOW = 120# Taille de la fenêtre glissante en secondes pour le calcul de la pente
R0_THRESHOLD = 15# Seuil de résistance R0 en Ohms pour le calcul de conductance
REGENERATION_TEMP = 750# Température en °C pour la régénération et point de consigne haute température
...
CO2_STABILITY_THRESHOLD = 30# Variation maximale en ppm pour considérer le CO2 comme stable
...
CELL_VOLUME = 0.9# Volume de la cellule de mesure en litres pour le calcul de masse de carbone
CO2_INCREASE_THRESHOLD = 30# Seuil d'augmentation de CO2 en ppm pour déclencher la détection
