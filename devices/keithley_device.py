...
import pyvisa
import sys
from core.config import config, KEITHLEY_GPIB_ADDRESS, KEITHLEY_READ_TIMEOUT, KEITHLEY_OPERATION_TIMEOUT, KEITHLEY_VISA_ERROR_CLOSING_FAILED, KEITHLEY_COMMANDS
...
class KeithleyDevice:
    ...
    def configure(self, polarization_voltage=None):
        ...
        try:
            ...
            voltage = polarization_voltage if polarization_voltage is not None else config.KEITHLEY_POLARIZATION_VOLTAGE
