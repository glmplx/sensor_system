...
from core.config import config, REGEN_DEFAULT_BAUD_RATE, REGEN_DEFAULT_TIMEOUT, REGEN_COMMAND_DELAY, REGEN_DATA_CHECK_INTERVAL, REGEN_MAX_DATA_CHECK_ATTEMPTS, REGEN_WRITE_DELAY
